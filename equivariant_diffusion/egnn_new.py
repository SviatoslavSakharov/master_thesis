...
class GCL(nn.Module):
    ...
    def node_model(self, x, edge_index, edge_attr, node_attr, style_vector=None, mask_atoms=None, mask_residues=None):
        row, col = edge_index
        ...
        if style_vector is not None:
            ...
            style_embedding = self.conditional_linear_layer(style_vector)
    ...
    def forward(self, h, edge_index, edge_attr=None, node_attr=None, node_mask=None, edge_mask=None, style_vector=None, mask_atoms=None, mask_residues=None):
        row, col = edge_index
        edge_feat, mij = self.edge_model(h[row], h[col], edge_attr, edge_mask)
        h, agg = self.node_model(h, edge_index, edge_feat, node_attr, style_vector, mask_atoms, mask_residues)
...
class EquivariantBlock(nn.Module):
    def __init__(self, hidden_nf, edge_feat_nf=2, device='cpu', act_fn=nn.SiLU(), n_layers=2, attention=True,
                 ...
                 normalization_factor=100, aggregation_method='sum', reflection_equiv=True, style_encoder=False):
    ...
    def forward(self, h, x, edge_index, node_mask=None, edge_mask=None,
                edge_attr=None, update_coords_mask=None, batch_mask=None, style_vector=None, mask_atoms=None, mask_residues=None):
        ...
        for i in range(0, self.n_layers):
            h, _ = self._modules["gcl_%d" % i](h, edge_index, edge_attr=edge_attr,
                                               node_mask=node_mask, edge_mask=edge_mask, style_vector=style_vector, mask_atoms=mask_atoms, mask_residues=mask_residues)
        if not self.style_encoder:
            ...
            x = None
        # print(f"In EquivariantBlock, x none {torch.isnan(x).any()}")
...
class EGNN(nn.Module):
    def __init__(self, in_node_nf, in_edge_nf, hidden_nf, device='cpu', act_fn=nn.SiLU(), n_layers=3, attention=False,
                 ...
                 sin_embedding=False, normalization_factor=100, aggregation_method='sum', reflection_equiv=True, style_encoder=False):
    ...
    def forward(self, h, x, edge_index, node_mask=None, edge_mask=None, update_coords_mask=None,
                batch_mask=None, edge_attr=None, style_vector=None, mask_atoms=None, mask_residues=None):
        # Edit Emiel: Remove velocity as input
        ...
        for i in range(0, self.n_layers):
            h, x = self._modules["e_block_%d" % i](
                ...
                batch_mask=batch_mask, style_vector=style_vector, mask_atoms=mask_atoms, mask_residues=mask_residues)
            # print("none in x ", torch.isnan(x).any())
